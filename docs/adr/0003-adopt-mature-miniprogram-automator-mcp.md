...
同源项目 `@purea/wechat-devtools-mcp`（miniprogram-automator-mcp）已迭代到 v1.0.0，包含 61 个 MCP 工具与 launch/connect 全套基础设施。

## 决策

1. **全量移植**：移植 61 个工具（生命周期 6、小程序级 20、页面 10、元素 25）及基础设施（automator 版本补丁、errors、launcher、session、utils、version），能力与参考项目对齐。
